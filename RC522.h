...
#define MFRC522_CS   RC6_bit
#define MFRC522_SCK  RC3_bit
#define MFRC522_SI  RC5_bit
#define MFRC522_SO  RC4_bit
#define MFRC522_RST RC2_bit

unsigned char SPI_ReadWrite(unsigned char data1)
{
  SSPBUF = data1;
  MFRC522_CS = 0;
  while (!BF_bit);
